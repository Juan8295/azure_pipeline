...
SVC_NAME=`systemd-escape --path "vsts.agent.juangoezcordoba.petclinic.juan-PC.service"`
SVC_DESCRIPTION="Azure Pipelines Agent (juangoezcordoba.petclinic.juan-PC)"
